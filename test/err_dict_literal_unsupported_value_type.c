// WP-011 Phase 3c.iii unsupported-value-type fixture.
//
// `_Complex double` is not in ncc's scalar-value whitelist, not a
// pointer, and there is no registered aggregate layout for it.  The
// dict-lowering pass rejects it before invoking the helper.
...
n00b_dict_t(int, _Complex double) x = d{1: 0.0};
