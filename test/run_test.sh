...
run_comptime_image_e2e() {
    ...
    "$NCC" \
        ...
        '--ncc-rstr-template-plain=({static n00b_string_t $0={.u8_bytes=$1,.data=$2,.codepoints=$3,.styling=nullptr};$14 static const struct{const void*start;uint64_t len;uint64_t tinfo;unsigned char scan_kind;void(*scan_cb)(void*,void*);void*scan_user;uint64_t object_id;const char*file;const void*identity;uint32_t flags;unsigned _BitInt(128) cached_hash;} $6={.start=(const void*)&$0,.len=(uint64_t)sizeof($0),.tinfo=$4,.scan_kind=$10,.scan_cb=$11,.scan_user=$12,.object_id=$8,.file=__FILE__,.identity=(const void*)$15,.flags=$9,.cached_hash=(n00b_uint128_t)$16};static const void * const $7 $13=(const void*)&$6;&$0;})' \
        '--ncc-rstr-template-styled=({$0 static n00b_string_t $1={.u8_bytes=$2,.data=$3,.codepoints=$4,.styling=$5};$16 static const struct{const void*start;uint64_t len;uint64_t tinfo;unsigned char scan_kind;void(*scan_cb)(void*,void*);void*scan_user;uint64_t object_id;const char*file;const void*identity;uint32_t flags;unsigned _BitInt(128) cached_hash;} $8={.start=(const void*)&$1,.len=(uint64_t)sizeof($1),.tinfo=$6,.scan_kind=$12,.scan_cb=$13,.scan_user=$14,.object_id=$10,.file=__FILE__,.identity=(const void*)$17,.flags=$11,.cached_hash=(n00b_uint128_t)$18};static const void * const $9 $15=(const void*)&$8;&$1;})' \
        '--ncc-rstr-static-ref-template-plain=static n00b_string_t $0={.u8_bytes=$1,.data=$2,.codepoints=$3,.styling=nullptr};$14 static const struct{const void*start;uint64_t len;uint64_t tinfo;unsigned char scan_kind;void(*scan_cb)(void*,void*);void*scan_user;uint64_t object_id;const char*file;const void*identity;uint32_t flags;unsigned _BitInt(128) cached_hash;} $6={.start=(const void*)&$0,.len=(uint64_t)sizeof($0),.tinfo=$4,.scan_kind=$10,.scan_cb=$11,.scan_user=$12,.object_id=$8,.file=__FILE__,.identity=(const void*)$15,.flags=$9,.cached_hash=(n00b_uint128_t)$16};static const void * const $7 $13=(const void*)&$6;' \
        '--ncc-rstr-static-ref-template-styled=$0 static n00b_string_t $1={.u8_bytes=$2,.data=$3,.codepoints=$4,.styling=$5};$16 static const struct{const void*start;uint64_t len;uint64_t tinfo;unsigned char scan_kind;void(*scan_cb)(void*,void*);void*scan_user;uint64_t object_id;const char*file;const void*identity;uint32_t flags;unsigned _BitInt(128) cached_hash;} $8={.start=(const void*)&$1,.len=(uint64_t)sizeof($1),.tinfo=$6,.scan_kind=$12,.scan_cb=$13,.scan_user=$14,.object_id=$10,.file=__FILE__,.identity=(const void*)$17,.flags=$11,.cached_hash=(n00b_uint128_t)$18};static const void * const $9 $15=(const void*)&$8;' \
