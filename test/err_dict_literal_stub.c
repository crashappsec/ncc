// WP-011 Phase 2 stub fixture; DELETE when Phase 3 implements dict
// lowering.  This fixture pins down the Phase 2 stub error so the
// regression test catches the day the dispatch path stops emitting
// "dict lowering not yet implemented in WP-011 Phase 2" — at that
// point Phase 3 should be live and this fixture is no longer
// meaningful.
